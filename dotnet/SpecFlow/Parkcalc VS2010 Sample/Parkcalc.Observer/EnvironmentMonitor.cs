...
namespace Parkcalc.Observer
{
    ...
    {
        private static EnvironmentType _environment = EnvironmentType.Testing;
        private static bool _smokeTest;

        public static EnvironmentType TestEnvironment
        {
            get
            {
                return _environment;
        ...
        private static void CheckEnvironment(Object[] attributes)
        {
            ...
            {
                Assert.Ignore("This test is not designed to be executed in the '" + TestEnvironment.ToString() + "' environment.");   
            }
        }
