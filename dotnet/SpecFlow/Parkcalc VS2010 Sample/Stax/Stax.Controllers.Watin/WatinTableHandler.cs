...
namespace Stax.Controllers.Web.Watin
{
    ...
    {
       /// <summary>
        /// This is to stuff the table into the _document and created the _table
        /// by stuffing it it will be something like this:
        /// _ie._domcontainer.Frame().Table() then from there we can do something with
        /// the column, row or cell.
        /// </summary>
        /// <param name="tableSrc">The table source defined in the control definition. It value
        /// got from the ControlStringHandler</param>
        public static void SetTable(string tableSrc)
        {
            string[] split = tableSrc.Split(',');
            _table = _document.Table(WatiN.Core.Find.By(split[1], new Regex(split[0])));
        }

        //public void isTableContains(string tableSource, string value)
        //{
        //    _control = new ControlStringHandler(tableSource);
        //    SetDocument();
        //    SetTable(_control.TableDefinition);

        //    return _table.Button().DomContainer.contain
        //}

        /// <summary>
        /// This is the table handler class and the container for the column, row and cell handler.
        /// </summary>
        public class WatinTableHandler
        {

            /// <summary>
            /// The Table Column Handler
            /// </summary>
            public class ColumnHandler
            {
                ...
                public static List<string> GetValue(string controlString, string columnName)
                {
                    return GetValue(controlString, columnName, false);
                }

                public static List<string> GetValue(string controlString, string columnName, bool includeHeaderRow)
                {
                    return null;
                }
            ...
            public class RowHandler
            {
                ...
                public List<string> GetValue(string controlString, string rowName)
                {
                    return null;
                }
            }
