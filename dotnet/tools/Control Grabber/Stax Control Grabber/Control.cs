...
namespace Stax.ControlGrabber
{
    ...
    public class Control
    {
        ...
        private Dictionary<ControlProperty, String> _additionalProperties;
        ...
        [XmlAttribute(AttributeName = "RawName")]
        public string RawName { get; set; }

        [XmlAttribute(AttributeName = "type")]
        public ControlType Type { get; set; }

        [XmlAttribute(AttributeName = "waitForComplete")]
        public bool WaitForComplete { get; set; }

        [XmlElement(ElementName = "controlKey")]
        public ControlKeyType Key { get; set; }
        ...
        //This property is not serialized as dictionary object cannot be serialized
        [XmlIgnore]
        public Dictionary<ControlProperty, String> AdditionalProperties { get { return _additionalProperties; } }
