...
namespace Stax.TFS2010
{
    public static class Helper
    {
        public static Uri GetCollectionUri(string[] args)
        {
            ...
            {
               LogWriter.WriteTextToLogFile("Please enter your TFS Team Project Collection URI as TFS_COLLECTION_URI in the app.config, \r\n" +
        ...
        internal static Uri GetCollectionUri()
        {
            string collectionURI = string.Empty;
            try
            {
                collectionURI = ConfigurationManager.AppSettings["TFS_COLLECTION_URI"].ToString();
            }
            ...
            return GetCollectionUri(new string[] {collectionURI});
        }
    }

    class LogWriter
    {
        static private string LogFilePathAndName = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Stax.TFS2010.log.txt";
	...
	static public class OSInfo
	{
        ...
        public static string FriendlyName
        {
            get
            {
                return OSInfo.Bits + "bit " + OSInfo.Name + " " + OSInfo.Edition + " " + OSInfo.ServicePack;
            }
        }

        public static string ShortNameWithIE
        {
            get
            {
                return  OSInfo.Bits + "bit " + OSInfo.Name + " " + OSInfo.ServicePack + " with " + GetshortIEVersionName;
            }
        }


        public static string GetFullIEVersionNumber
         {
             get
             {
        ...
        public static string GetFriendyIEVersionName
        {
            get
            {
                string[] splitter = GetFullIEVersionNumber.Split(".".ToCharArray());
                return "Internet Explorer " + splitter[0];
            }
        }

        public static string GetshortIEVersionName
        {
            get
            {
                string[] splitter = GetFullIEVersionNumber.Split(".".ToCharArray());
                return "IE" + splitter[0];
            }
        }
